...
{
    public partial class thanhphos : System.Web.UI.Page
    {
        #region Declare
        ...
        {
            return "thanhpho.aspx?id=" + Utils.CStrDef(obj_id);
        }
        private void SearchResult()
        {
            try
            {
                ...
                var AllList = (from g in DB.VL_CITies
        ...
        private void EventDelete(DataGridCommandEventArgs e)
        {
            try
            {
                ...
                var g_delete = DB.GetTable<VL_CITY>().Where(g => g.ID == PropId);

                DB.VL_CITies.DeleteAllOnSubmit(g_delete);
                DB.SubmitChanges();
        ...
        protected void lbtDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //delete 
                var g_delete = DB.GetTable<VL_CITY>().Where(g => items.Contains(Convert.ToInt32(g.ID)));
