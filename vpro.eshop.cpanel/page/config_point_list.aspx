            ...
            <tr>
                <td colspan="3">
                    <asp:DataGrid ID="GridItemList" CellPadding="0" runat="server" AutoGenerateColumns="False"
                        Width="100%" DataKeyField="POINT_ID" CssClass="tdGridTable" SelectedIndex="0"
                        ...
                        OnPageIndexChanged="GridItemList_PageIndexChanged" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Tỉ lệ điểm chuyển sang tiền" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="POINT_POINT_TO_MONEY">
                                <ItemTemplate>
                                    <a href='<%# getLink(DataBinder.Eval(Container.DataItem, "POINT_ID")) %>'>
                                        <%# DataBinder.Eval(Container.DataItem, "POINT_POINT_TO_MONEY")%>
                                    </a>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="40%"></HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow" HorizontalAlign="Center"></ItemStyle>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="Tỉ lệ tiền chuyển sang điểm" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="POINT_MONEY_TO_POINT">
                                <ItemTemplate>
                                    <a href='<%# getLink(DataBinder.Eval(Container.DataItem, "POINT_ID")) %>'>
                                        <%# DataBinder.Eval(Container.DataItem, "POINT_MONEY_TO_POINT")%>
                                    </a>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="40%">
                                </HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow" HorizontalAlign="Center"></ItemStyle>
                            </asp:TemplateColumn>
