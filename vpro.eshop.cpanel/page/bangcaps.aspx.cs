...
{
    public partial class bangcaps : System.Web.UI.Page
    {
        #region Declare
        ...
        {
            return "bangcap.aspx?id=" + Utils.CStrDef(obj_id);
        }
        private void SearchResult()
        {
            try
            {
                ...
                var AllList = (from g in DB.VL_TRINHDOHOCVANs
        ...
        private void EventDelete(DataGridCommandEventArgs e)
        {
            try
            {
                ...
                var g_delete = DB.GetTable<VL_TRINHDOHOCVAN>().Where(g => g.ID == PropId);

                DB.VL_TRINHDOHOCVANs.DeleteAllOnSubmit(g_delete);
                DB.SubmitChanges();
        ...
        protected void lbtDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //delete 
                var g_delete = DB.GetTable<VL_TRINHDOHOCVAN>().Where(g => items.Contains(Convert.ToInt32(g.ID)));
