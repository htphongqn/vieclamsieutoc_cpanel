...
namespace vpro.eshop.cpanel.page
{
    public partial class aditem_list : System.Web.UI.Page
    {
        ...
        public string getPosition(object obj_position)
        {
            ...
            {
                case 1: str = "Giữa 1 NTV";
                    break;
                case 2: str = "Giữa 2 NTV";
                    break;
                case 3: str = "Giữa 3 NTV";
                    break;
                case 4: str = "Phải 1 NTV";
                    break;
                case 5: str = "Phải 2 NTV";
                    break;
                case 6: str = "Phải 3 NTV";
                    break;
                case 7: str = "Phải 4 NTV";
                    break;
                case 8: str = "Phải 5 NTV";
                    break;
                case 9: str = "Phải 6 NTV";
                    break;
                case 10: str = "Ngang NTV";
                    break;
                case 11: str = "Giữa 1 NTD";
                    break;
                case 12: str = "Giữa 2 NTD";
                    break;
                case 13: str = "Giữa 3 NTD";
                    break;
                case 14: str = "Phải 1 NTD";
                    break;
                case 15: str = "Phải 2 NTD";
                    break;
                case 16: str = "Phải 3 NTD";
                    break;
                case 17: str = "Phải 4 NTD";
                    break;
                case 18: str = "Phải 5 NTD";
                    break;
                case 19: str = "Phải 6 NTD";
                    break;
                case 20: str = "Ngang NTD";
                    break;
            }
            return str;            
        }
