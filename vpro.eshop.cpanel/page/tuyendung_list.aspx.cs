...
{
    public partial class tuyendung_list : System.Web.UI.Page
    {
        ...
        {
            return "tuyendung.aspx?news_id=" + Utils.CStrDef(obj_id);
        }
        ...
        private void EventDelete(DataGridCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("tuyendung_list.aspx");
            }
        }
        ...
        protected void lbtSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                foreach (DataGridItem item in GridItemList.Items)
                {
                    ...
                    if (check.Checked)
                    {
                        strLink = "tuyendung.aspx?news_id=" + Utils.CStrDef(GridItemList.DataKeys[i]);
                        break;
                    }
                    i++;
                }
