...
{
    public partial class dotuois : System.Web.UI.Page
    {
        #region Declare
        ...
        {
            return "dotuoi.aspx?id=" + Utils.CStrDef(obj_id);
        }
        private void SearchResult()
        {
            try
            {
                ...
                var AllList = (from g in DB.VL_DOTUOIs
        ...
        private void EventDelete(DataGridCommandEventArgs e)
        {
            try
            {
                ...
                var g_delete = DB.GetTable<VL_DOTUOI>().Where(g => g.ID == PropId);

                DB.VL_DOTUOIs.DeleteAllOnSubmit(g_delete);
                DB.SubmitChanges();
        ...
        protected void lbtDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //delete 
                var g_delete = DB.GetTable<VL_DOTUOI>().Where(g => items.Contains(Convert.ToInt32(g.ID)));
