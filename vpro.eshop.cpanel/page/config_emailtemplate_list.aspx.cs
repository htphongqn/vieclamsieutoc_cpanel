...
{
    public partial class config_emailtemplate_list : System.Web.UI.Page
    {

        #region Declare

        int _count = 0; //int lang = 0;
        ...
        {
            return "config_emailtemplate.aspx?oid=" + Utils.CStrDef(obj_id);
        }
        ...
        protected void GridItemList_SortCommand(object source, DataGridSortCommandEventArgs e)
        {
            ...
            DataTable dataTable = Session["EmailTemplateList"] as DataTable;
        ...
        protected void GridItemList_PageIndexChanged(object source, DataGridPageChangedEventArgs e)
        {
            ...
            GridItemList.DataSource = Session["EmailTemplateList"] as DataTable;
            GridItemList.DataBind();
        }
