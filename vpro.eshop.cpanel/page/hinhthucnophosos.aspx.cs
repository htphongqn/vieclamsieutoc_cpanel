...
{
    public partial class hinhthucnophosos : System.Web.UI.Page
    {
        #region Declare
        ...
        {
            return "hinhthucnophoso.aspx?id=" + Utils.CStrDef(obj_id);
        }
        ...
        private void EventDelete(DataGridCommandEventArgs e)
        {
            try
            {
                ...
                var g_delete = DB.GetTable<VL_HINHTHUCNOPHOSO>().Where(g => g.ID == PropId);

                DB.VL_HINHTHUCNOPHOSOs.DeleteAllOnSubmit(g_delete);
                DB.SubmitChanges();
        ...
        protected void lbtDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //delete 
                var g_delete = DB.GetTable<VL_HINHTHUCNOPHOSO>().Where(g => items.Contains(Convert.ToInt32(g.ID)));
