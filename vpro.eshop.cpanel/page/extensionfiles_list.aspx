            ...
            <tr>
                <td colspan="3">
                    <asp:DataGrid ID="GridItemList" CellPadding="0" runat="server" AutoGenerateColumns="False"
                        Width="100%" DataKeyField="EXT_FILE_ID" CssClass="tdGridTable" SelectedIndex="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Tên" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                ...
                                SortExpression="EXT_FILE_NAME">
                                <ItemTemplate>
                                    <a href='<%# getLink(DataBinder.Eval(Container.DataItem, "EXT_FILE_ID")) %>'>
                                        <%# DataBinder.Eval(Container.DataItem, "EXT_FILE_NAME")%>
                                    </a>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%"></HeaderStyle>
                            ...
                            <asp:TemplateColumn HeaderText="Mô tả" HeaderStyle-Width="94%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="EXT_FILE_DESC">
                                <ItemTemplate>
                                    <a href='<%# getLink(DataBinder.Eval(Container.DataItem, "EXT_FILE_ID")) %>'>
                                        <%# DataBinder.Eval(Container.DataItem, "EXT_FILE_DESC")%>
                                    </a>
                                </ItemTemplate>
                            ...
                            <asp:TemplateColumn HeaderText="Icon" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False">
                                <ItemTemplate>
                                    <%# getLinkIcon(DataBinder.Eval(Container.DataItem, "EXT_FILE_ID"), DataBinder.Eval(Container.DataItem, "EXT_FILE_IMAGE")) %>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%"></HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow"></ItemStyle>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="#" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False">
                                <ItemTemplate>
                                    <a href='<%# getLink(DataBinder.Eval(Container.DataItem, "EXT_FILE_ID")) %>'>Chỉnh sửa
                                    </a>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%"></HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow" HorizontalAlign="Center"></ItemStyle>
