...
namespace vpro.eshop.cpanel.page
{
    public partial class booking_list : System.Web.UI.Page
    {
        ...
        //}
        public string getsex(object oid)
        {
        ...
        public string getTypeClass(object oid)
        {
        ...
        public string getNameHotel(object oid)
        {
            //int id = Utils.CIntDef(oid);
        ...
        protected void lbtDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //delete 
                var g_delete = DB.GetTable<ESHOP_CONTACT_BOOKING>().Where(g => items.Contains(g.CONT_ID));
