<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="config_emailtemplate_insert.aspx.cs" Inherits="vpro.eshop.cpanel.page.config_emailtemplate_insert" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <title>Cấu hình Email's Template | vpro.eshop</title>
...
<%--        <div class="icon_function_Child">
        ...
        <div class="icon_function_Child">
            <a href="config_emailtemplate_list.aspx">
    ...
    <div id="field">
        <table width="auto" border="0">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="txtCode" id="txtCode" runat="server" style="width: 743px;" />
                </td>
            </tr>
            <tr>
                <th valign="top" class="left">
                ...
                <td>
                    <input type="text" name="txtSubject" id="txtSubject" runat="server" style="width: 743px;" />
                </td>
            </tr>
            <tr>
                <th valign="top" class="left">
                ...
                <td>
                    <textarea id="txtBody" cols="20" rows="10" class="mrk mceEditor" style="height: 500px;" runat="server"></textarea>
                </td>
            </tr>
            <tr>
                <th valign="top" class="left">
                ...
                <td>
                    <textarea id="txtNote" runat="server" class="mceNoEditor" style="width: 743px;"></textarea>  
                </td>
            </tr>
            <tr>
                <th valign="top" class="left">
                ...
                <td>
                    <table width="743px">
                      <tr>
                        <td colspan="3"><b>Phần nội dung những chữ có ký tự
                              <span style="color:Red">@</span> phía trước là dùng để thay thế:</b></td>
                      </tr>
                        <tr>
                            <td valign="top">                              
                              <span style="color:Red">@name:</span> Họ tên khách hàng<br />
                              <span style="color:Red">@email:</span> Email khách hàng<br />
                              <span style="color:Red">@phone:</span> Số điện thoại khách hàng<br />
                              <span style="color:Red">@address:</span> Địa chỉ khách hàng<br />
                              <span style="color:Red">@content:</span> Nội dung của khách hàng gửi
                            </td>
                            <td valign="top">
                                <span style="color:Red">@fromdate:</span> Ngày đi<br />
                                <span style="color:Red">@todate:</span> Ngày về<br />
                                <span style="color:Red">@hotel:</span> Tên khách sạn<br />
                                <span style="color:Red">@room:</span> Loại phòng<br />
                                <span style="color:Red">@quantity:</span> Số lượng đặt<br />
                                <span style="color:Red">@cusm:</span> Số lượng người lớn<br />
                                <span style="color:Red">@cuss:</span> Số lượng trẻ em
                            </td>
                            <td valign="top">
                                <span style="color:Red">@company:</span> Công ty của khách hàng<br />
                                <span style="color:Red">@project:</span> Dự án khách hàng chọn
                            </td>
                        </tr>
                    </table>
