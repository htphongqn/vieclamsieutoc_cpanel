<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="tuyendung_list.aspx.cs" Inherits="vpro.eshop.cpanel.page.tuyendung_list" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <title>DS Tuyển dụng | Vpro.Eshop</title>
    ...
    <div id="field">
        <table width="100%" border="0">
            ...
            <tr>
                ...
                <td width="200px;">
                    <asp:DropDownList ID="ddlTinhtranghoso" runat="server" AutoPostBack="True">
                    ...
                    <asp:DataGrid ID="GridItemList" CellPadding="0" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Bình luận" HeaderStyle-Width="91%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="NEWS_TITLE" Visible="false">
                                <ItemTemplate>
                            ...
                            <asp:TemplateColumn HeaderText="Nhà tuyển dụng" HeaderStyle-Width="91%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
