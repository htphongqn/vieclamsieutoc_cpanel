<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="album_list.aspx.cs" Inherits="vpro.eshop.cpanel.page.album_list" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <title>Danh sách khách hàng | Vpro.Eshop </title>
            ...
            <tr>
                <td colspan="3">
                    <asp:DataGrid ID="GridItemList" CellPadding="0" runat="server" AutoGenerateColumns="False"
                        Width="100%" DataKeyField="ALBUM_ID" CssClass="tdGridTable" SelectedIndex="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Tên" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                ...
                                <ItemTemplate>
                                    <a href='<%# getLink(DataBinder.Eval(Container.DataItem, "ALBUM_ID")) %>'>
                            ...
                            <asp:TemplateColumn HeaderText="Thứ tự" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="ALBUM_ORDER">
                                <ItemTemplate>
                                        <%# DataBinder.Eval(Container.DataItem, "ALBUM_ORDER")%>
                                </ItemTemplate>
                            ...
                            <asp:TemplateColumn HeaderText="Loại" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="ALBUM_TYPE">
                                <ItemTemplate>
                                
                                        <%# DataBinder.Eval(Container.DataItem, "ALBUM_TYPE")%>
                            ...
                            <asp:TemplateColumn HeaderText="#" HeaderStyle-Width="95%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False">
                                <ItemTemplate>
                                    <a href='<%# getLink(DataBinder.Eval(Container.DataItem, "ALBUM_ID")) %>'>Chỉnh sửa
                                    </a>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%"></HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow" HorizontalAlign="Center"></ItemStyle>
