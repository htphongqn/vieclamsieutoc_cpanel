            ...
            <tr id="trHotel" runat ="server" visible="false">
                <td>
                    <table>
                        ...
                        <tr>
                            <td>
                                <textarea id="txtGioithieu" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="18" align="left" style="border-bottom: #e3e3e3 1px  solid;" class="general">
                        ...
                        <tr>
                            <td>
                                <textarea id="txtPhongnghi" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="18" align="left" style="border-bottom: #e3e3e3 1px  solid;" class="general">
                        ...
                        <tr>
                            <td>
                                <textarea id="txtAmthuc" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="18" align="left" style="border-bottom: #e3e3e3 1px  solid;" class="general">
                        ...
                        <tr>
                            <td>
                                <textarea id="txtGiaitri" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="18" align="left" style="border-bottom: #e3e3e3 1px  solid;" class="general">
                        ...
                        <tr>
                            <td>
                                <textarea id="txtHoinghi" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="18" align="left" style="border-bottom: #e3e3e3 1px  solid;" class="general">
            ...
            <tr id="trProject" runat ="server" visible ="false">
                <td>
                    <table>
                        ...
                        <tr>
                            <td>
                                <textarea id="txtphongnghida" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td height="18" align="left" style="border-bottom: #e3e3e3 1px  solid;" class="general">
                        ...
                        <tr>
                            <td>
                                <textarea id="txtTiendo" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                            </td>
                        </tr>
                    </table>
                </td>
