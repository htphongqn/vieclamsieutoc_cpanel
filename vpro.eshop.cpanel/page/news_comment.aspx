...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <title>Thông tin phản hồi | vpro.eshop</title>
                    ...
                    <asp:DataGrid ID="GridItemList" CellPadding="0" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderStyle-Width="1%" ItemStyle-Wrap="False" HeaderStyle-CssClass="tdGridHeader"
                                ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False">
                                <HeaderTemplate>
                                    <input type="checkbox" id="toggleDisplay" runat="server" onclick="javascript: ToggleAll(this,0,'chkDisplay');"
                                        style="border-top-style: none; border-right-style: none; border-left-style: none;
                                        border-bottom-style: none" name="toggleDisplay">Ẩn/Hiện
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <input id="chkDisplay" type="checkbox" name="chkDisplay" runat="server" style="border-top-style: none;
                                        border-right-style: none; border-left-style: none; border-bottom-style: none" checked='<%# GetCheck(DataBinder.Eval(Container.DataItem, "COMMENT_STATUS")) %>'>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%"></HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow" HorizontalAlign="Center"></ItemStyle>
                            </asp:TemplateColumn>
